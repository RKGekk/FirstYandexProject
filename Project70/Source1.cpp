...
public:
    ...
    template <typename DocumentPredicate>
    vector<Document> FindTopDocuments(const string& rawQuery, DocumentPredicate document_predicate) const {
        Query query;
